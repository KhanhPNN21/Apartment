    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg ">
            <div class="container d-flex justify-content-between">
                <a class="navbar-brand" href="https://www.facebook.com/jachnguyen.nguyen">ApartmentProvjp.com</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>

                <div class=" d-flex align-items-center mx-auto"> <!-- Sử dụng mx-auto để căn giữa -->
                    <img class="logo mx-3" src="img/logo.jpg" alt="Logo"> <!-- Thêm logo ở đây -->
                </div>
        ...
        <nav class="navbar navbar-expand-lg sticky-navbar navbar-padding" style="background-color: #B39B86;"> <!-- Màu be -->
            <div class="container">
